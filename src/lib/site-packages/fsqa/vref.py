...
class VREF(object):
    ...
    def __init__(self, ref, oldsha, newsha, repo_path, *branches):
        self.gl_user = os.environ["GL_USER"]

        # set this flag True if the arg passed to the VREF matches the ref being pushed
        self.branches = branches
        self.require_vref = True if not branches else (os.path.basename(ref) in branches)
    ...
    def fail(self, **kwargs):
        ...
        print self.VREF + "/".join(self.branches)
