...
class VREF(object):
    ...
    def __init__(self, ref, oldsha, newsha, repo_path, branch):
        self.gl_user = os.environ["GL_USER"]

        # set this flag True if the arg passed to the VREF matches the ref being pushed
        self.branch = branch
        self.require_vref = True if not branch else os.path.basename(ref) == branch
    ...
    def fail(self, **kwargs):
        ...
        print self.VREF + ("/" + self.branch) if self.branch else ""
