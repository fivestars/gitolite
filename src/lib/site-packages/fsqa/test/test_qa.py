...
with patch("fsqa.phabricator_vref.PhabricatorVREF", MagicPhabricatorVREF):
    ...
    from fsqa.differential import Differential
...
class TestOwnership(unittest.TestCase):
    ...
    def test_accept_revisions(self, mock_repo):
        "Test that not pushing an entire revision results in a failure"
        mock_commit_dict = {"c95c850cec171776f14d632cee2b007d1332918e": ["testfile.py"]}
        file_to_owner_dict = {"testfile.py": [self.pushing_user]}
        revision_dict = {
            "1": {"commits": ["c95c850cec171776f14d632cee2b007d1332918e",
        ...
        ownership_object = Ownership("mock", "c95c850cec171776f14d632cee2b007d1332918e", ".git")
        peer_object = Peer("mock", "c95c850cec171776f14d632cee2b007d1332918e", ".git")
        differential_object = Differential("mock", "c95c850cec171776f14d632cee2b007d1332918e", ".git")

        assert differential_object.accept_revisions() == False

    def test_accept_revisions_success(self, mock_repo):
        "Test that the right revisions are pushed"
        mock_commit_dict = {"c95c850cec171776f14d632cee2b007d1332918e": ["testfile.py"],
                            "tttttttttttttttttttttttttttttttttttttttt": ["testfile.py"]}
        file_to_owner_dict = {"testfile.py": [self.pushing_user]}
        revision_dict = {
            "1": {"commits": ["c95c850cec171776f14d632cee2b007d1332918e",
                              "tttttttttttttttttttttttttttttttttttttttt"],
        ...
        assert differential_object.accept_revisions() == True
